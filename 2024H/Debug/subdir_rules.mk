...
build-1856075873: ../empty.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.27.0/sysconfig_cli.bat" --script "C:/Users/lky/workspace_ccstheia/Car2.1/empty.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_02_00_05/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-1856075873 ../empty.syscfg
device.opt: build-1856075873
device.cmd.genlibs: build-1856075873
ti_msp_dl_config.c: build-1856075873
ti_msp_dl_config.h: build-1856075873
Event.dot: build-1856075873
